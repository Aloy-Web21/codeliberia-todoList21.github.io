...
// mongoose.connect("mongodb+srv://admin-aloy:HxCvHOFltFxNey2L@cluster0.u5lery1.mongodb.net/?retryWrites=true&w=majority/todoList",{
...
mongoose.connect("mongodb+srv://admin-aloy:HxCvHOFltFxNey2L@cluster0.u5lery1.mongodb.net/?retryWrites=true&w=majority/todoList", {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false});      // 351. Changed URL to allow for use of an MongoDB Atlas cluster in order to host database
...
// const gridFSBucket = mongoose.mongo.GridFSBucket(connect.mongodb);
